describe('Text box with max characters', () => {
    it('displays the appropriate remaining characters count', () => {
        ...
        cy.get('span')
            .eq(1) // argument is the index of the above element we want to select.
        ...
        cy.get('input').eq(1).type('hello'); // 'hello' = 5 letters out of 15 used
        ...
        cy.get('input').eq(1).type(' my friend'); // use the rest of the 10 characters left
